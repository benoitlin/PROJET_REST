---------------------------------------------------------
-- INSERTIONS SQL (40 FILMS - Shōnen/Populaire)
---------------------------------------------------------
USE projet_rest;

-- 1. Insertion dans la table users (4 utilisateurs)
...
-- 2. Insertion dans la table salles (10 Cinémas Parisiens)
...
-- 3. Insertion dans la table films (40 Animes - ID 1 à 40)
INSERT INTO films (id, titre, duree, langue, sous_titres, realisateur, age_minimum, description_film, user_id) VALUES
-- Franchises (3 max par série) - Owner ID: 1
(1, 'Demon Slayer : Le Train de l\'Infini', 117, 'VO', 'Français', 'Haruo Sotozaki (Ufotable)', 12, 'Tanjiro et ses compagnons se lancent dans une nouvelle mission à bord du Train de l\'Infini.', 1),
...
(16, 'Bleach: The DiamondDust Rebellion', 92, 'VF', NULL, 'Noriyuki Abe', 12, 'Le capitaine Toshiro Hitsugaya est accusé d\'avoir volé un artefact du Soul Society.', 1),
...
(21, 'Ghost in the Shell', 83, 'VO', 'Français', 'Mamoru Oshii', 16, 'Un cyborg policier enquête sur un cybercriminel appelé le Maître de Marionnettes.', 2),
...
(24, 'Code Geass: Lelouch of the Re;surrection', 112, 'VF', NULL, 'Gorō Taniguchi', 12, 'Dix ans après la mort de Lelouch, la paix est brisée par une nouvelle menace.', 2),
...
-- 4. Insertion des acteurs (Seiyū) (30 acteurs principaux)
...
-- 5. Lien acteur_film (Exemples de liens)
...
-- 6. Insertion dans la table programmation_seance (60 Séances réelles sur 7 jours)
-- Date de référence : Semaine du Lundi 2026-03-01 au Dimanche 2026-03-07
